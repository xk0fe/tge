...
// non-inline
function D3DXVec2Normalize(out vOut: TD3DXVector2; const v: TD3DXVector2): PD3DXVector2; stdcall;
...
function D3DXVec2CatmullRom(out vOut: TD3DXVector2;
   const v0, v1, v2: TD3DXVector2; s: Single): PD3DXVector2; stdcall;
...
function D3DXVec3CatmullRom(out vOut: TD3DXVector3;
   const v1, v2, v3: TD3DXVector3; s: Single): PD3DXVector3; stdcall;
...
function D3DXMatrixfDeterminant(const m: TD3DXMatrix): Single; stdcall;
{$EXTERNALSYM D3DXMatrixfDeterminant}

function D3DXMatrixTranspose(out pOut: TD3DXMatrix; const pM: TD3DXMatrix): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixTranspose}

// Matrix multiplication.  The result represents the transformation M2
// followed by the transformation M1.  (Out = M1 * M2)
function D3DXMatrixMultiply(out mOut: TD3DXMatrix; const m1, m2: TD3DXMatrix): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixMultiply}

// Matrix multiplication, followed by a transpose. (Out = T(M1 * M2))
function D3DXMatrixMultiplyTranspose(out pOut: TD3DXMatrix; const pM1, pM2: TD3DXMatrix): PD3DXMatrix; stdcall;
...
function D3DXMatrixScaling(out mOut: TD3DXMatrix; sx, sy, sz: Single): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixScaling}

// Build a matrix which translates by (x, y, z)
function D3DXMatrixTranslation(out mOut: TD3DXMatrix; x, y, z: Single): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixTranslation}

// Build a matrix which rotates around the X axis
function D3DXMatrixRotationX(out mOut: TD3DXMatrix; angle: Single): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixRotationX}

// Build a matrix which rotates around the Y axis
function D3DXMatrixRotationY(out mOut: TD3DXMatrix; angle: Single): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixRotationY}

// Build a matrix which rotates around the Z axis
function D3DXMatrixRotationZ(out mOut: TD3DXMatrix; angle: Single): PD3DXMatrix; stdcall;
...
function D3DXMatrixRotationQuaternion(out mOut: TD3DXMatrix; const Q: TD3DXQuaternion): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixRotationQuaternion}

// Yaw around the Y axis, a pitch around the X axis,
// and a roll around the Z axis.
function D3DXMatrixRotationYawPitchRoll(out mOut: TD3DXMatrix; yaw, pitch, roll: Single): PD3DXMatrix; stdcall;
...
function D3DXMatrixLookAtRH(out mOut: TD3DXMatrix; const Eye, At, Up: TD3DXVector3): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixLookAtRH}

// Build a lookat matrix. (left-handed)
function D3DXMatrixLookAtLH(out mOut: TD3DXMatrix; const Eye, At, Up: TD3DXVector3): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixLookAtLH}

// Build a perspective projection matrix. (right-handed)
function D3DXMatrixPerspectiveRH(out mOut: TD3DXMatrix; w, h, zn, zf: Single): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixPerspectiveRH}

// Build a perspective projection matrix. (left-handed)
function D3DXMatrixPerspectiveLH(out mOut: TD3DXMatrix; w, h, zn, zf: Single): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixPerspectiveLH}

// Build a perspective projection matrix. (right-handed)
function D3DXMatrixPerspectiveFovRH(out mOut: TD3DXMatrix; flovy, aspect, zn, zf: Single): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixPerspectiveFovRH}

// Build a perspective projection matrix. (left-handed)
function D3DXMatrixPerspectiveFovLH(out mOut: TD3DXMatrix; flovy, aspect, zn, zf: Single): PD3DXMatrix; stdcall;
...
function D3DXMatrixOrthoRH(out mOut: TD3DXMatrix; w, h, zn, zf: Single): PD3DXMatrix; stdcall;
{$EXTERNALSYM D3DXMatrixOrthoRH}

// Build an ortho projection matrix. (left-handed)
function D3DXMatrixOrthoLH(out mOut: TD3DXMatrix; w, h, zn, zf: Single): PD3DXMatrix; stdcall;
...
function D3DXPlaneNormalize(out pOut: TD3DXPlane; const p: TD3DXPlane): PD3DXPlane; stdcall;
...
function D3DXPlaneTransform(out pOut: TD3DXPlane; const m: TD3DXMatrix): PD3DXPlane; stdcall;
...
type
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXMatrixStack> _di_ID3DXMatrixStack;'}
...
///////////////////////////////////////////////////////////////////////////
  ...
  {$EXTERNALSYM PID3DXBuffer}
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXBuffer> _di_ID3DXBuffer;'}
...
///////////////////////////////////////////////////////////////////////////
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXFont> _di_ID3DXFont;'}
...
type
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXSprite> _di_ID3DXSprite;'}
...
type
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXRenderToSurface> _di_ID3DXRenderToSurface;'}
...
type
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXRenderToEnvMap> _di_ID3DXRenderToEnvMap;'}
...
//-------------------------------------------------------------------------
function D3DXGetErrorStringA(hr: HResult; pBuffer: PAnsiChar; BufferLen: LongWord): HResult; stdcall; overload;
{$EXTERNALSYM D3DXGetErrorStringA}
function D3DXGetErrorStringW(hr: HResult; pBuffer: PWideChar; BufferLen: LongWord): HResult; stdcall; overload;
{$EXTERNALSYM D3DXGetErrorStringW}
function D3DXGetErrorString(hr: HResult; pBuffer: PChar; BufferLen: LongWord): HResult; stdcall; overload;
...
//////////////////////////////////////////////////////////////////////////////
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXEffect> _di_ID3DXEffect;'}
...
type
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXBaseMesh> _di_ID3DXBaseMesh;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXMesh> _di_ID3DXMesh;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXPMesh> _di_ID3DXPMesh;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXSPMesh> _di_ID3DXSPMesh;'}
  ...
  ID3DXSPMesh = interface(IUnknown)
    ...
    function ClonePMeshFVF(Options, FVF: DWord; ppDevice: IDirect3DDevice8;
      pVertexRemapOut: PDWord; out ppCloneMesh: ID3DXMesh): HResult; stdcall;
    function ClonePMesh(Options: DWord; pDeclaration: PDWord;
...
type
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<ID3DXSkinMesh> _di_ID3DXSkinMesh;'}
...
function D3DXComputeNormals(pMesh: ID3DXBaseMesh; pAdjacency: PDWord): HResult; stdcall;
{$EXTERNALSYM D3DXComputeNormals}

function D3DXCreateBuffer(NumBytes: DWord; out ppBuffer: ID3DXBuffer): HResult; stdcall;
...
function D3DXGetFVFVertexSize(FVF: DWord): LongWord; stdcall;
{$EXTERNALSYM D3DXGetFVFVertexSize}

function D3DXDeclaratorFromFVF(FVF: DWord; out Declaration: TFVFDeclaration): HResult; stdcall;
{$EXTERNALSYM D3DXDeclaratorFromFVF}

function D3DXFVFFromDeclarator(pDeclarator: PDWord; out pFVF: DWord): HResult; stdcall;
...
// In Pascal mapped to DLL exported "D3DXFilterTexture" function
...
function D3DXVec2Normalize; external d3dx8dll;
function D3DXVec2Hermite; external d3dx8dll;
function D3DXVec2CatmullRom; external d3dx8dll;
function D3DXVec2BaryCentric; external d3dx8dll;
function D3DXVec2Transform; external d3dx8dll;
function D3DXVec2TransformCoord; external d3dx8dll;
function D3DXVec2TransformNormal; external d3dx8dll;

function D3DXVec3Normalize; external d3dx8dll;
function D3DXVec3Hermite; external d3dx8dll;
function D3DXVec3CatmullRom; external d3dx8dll;
function D3DXVec3BaryCentric; external d3dx8dll;
function D3DXVec3Transform; external d3dx8dll;
function D3DXVec3TransformCoord; external d3dx8dll;
function D3DXVec3TransformNormal; external d3dx8dll;
function D3DXVec3Project; external d3dx8dll;
function D3DXVec3Unproject; external d3dx8dll;

function D3DXVec4Cross; external d3dx8dll;
function D3DXVec4Normalize; external d3dx8dll;
...
function D3DXMatrixMultiplyTranspose; external d3dx8dll;
...
function D3DXMatrixRotationX; external d3dx8dll;
function D3DXMatrixRotationY; external d3dx8dll;
function D3DXMatrixRotationZ; external d3dx8dll;
...
function D3DXMatrixLookAtLH; external d3dx8dll;
...
procedure D3DXQuaternionSquadSetup; external d3dx8dll;
...
function D3DXFresnelTerm; external d3dx8dll;
...
function D3DXCreateFont; external d3dx8dll;
function D3DXCreateFontIndirect; external d3dx8dll;

function D3DXCreateSprite; external d3dx8dll;

function D3DXCreateRenderToSurface; external d3dx8dll;
function D3DXCreateRenderToEnvMap; external d3dx8dll;

function D3DXAssembleShaderFromFileA; external d3dx8dll name 'D3DXAssembleShaderFromFileA';
function D3DXAssembleShaderFromFileW; external d3dx8dll name 'D3DXAssembleShaderFromFileW';
function D3DXAssembleShaderFromFile; external d3dx8dll name 'D3DXAssembleShaderFromFileA';
function D3DXAssembleShaderFromResourceA; external d3dx8dll name 'D3DXAssembleShaderFromResourceA';
function D3DXAssembleShaderFromResourceW; external d3dx8dll name 'D3DXAssembleShaderFromResourceW';
function D3DXAssembleShaderFromResource; external d3dx8dll name 'D3DXAssembleShaderFromResourceA';
function D3DXAssembleShader; external d3dx8dll;

function D3DXGetErrorStringA(hr: HResult; pBuffer: PAnsiChar; BufferLen: LongWord): HResult; external d3dx8dll name 'D3DXGetErrorStringA';
function D3DXGetErrorStringW(hr: HResult; pBuffer: PWideChar; BufferLen: LongWord): HResult; external d3dx8dll name 'D3DXGetErrorStringW';
function D3DXGetErrorString(hr: HResult; pBuffer: PChar; BufferLen: LongWord): HResult; external d3dx8dll name 'D3DXGetErrorStringA';
...
function D3DXCreateEffectFromFileA; external d3dx8dll name 'D3DXCreateEffectFromFileA';
function D3DXCreateEffectFromFileW; external d3dx8dll name 'D3DXCreateEffectFromFileW';
function D3DXCreateEffectFromFile; external d3dx8dll name 'D3DXCreateEffectFromFileA';
function D3DXCreateEffectFromResourceA; external d3dx8dll name 'D3DXCreateEffectFromResourceA';
function D3DXCreateEffectFromResourceW; external d3dx8dll name 'D3DXCreateEffectFromResourceW';
function D3DXCreateEffectFromResource; external d3dx8dll name 'D3DXCreateEffectFromResourceA';
function D3DXCreateEffect; external d3dx8dll;
...
function D3DXLoadMeshFromXInMemory; external d3dx8dll;
function D3DXLoadMeshFromXResource; external d3dx8dll;
...
function D3DXTessellateNPatches; external d3dx8dll;
function D3DXGetFVFVertexSize; external d3dx8dll;
...
function D3DXIntersectSubset; external d3dx8dll;
function D3DXSplitMesh; external d3dx8dll;
function D3DXIntersectTri; external d3dx8dll;
function D3DXSphereBoundProbe; external d3dx8dll;
function D3DXBoxBoundProbe; external d3dx8dll;
function D3DXComputeTangent; external d3dx8dll;
function D3DXConvertMeshSubsetToSingleStrip; external d3dx8dll;
function D3DXConvertMeshSubsetToStrips; external d3dx8dll;
...
function D3DXCreateBox; external d3dx8dll;
...
function D3DXComputeNormalMap; external d3dx8dll;
function D3DXGetImageInfoFromFileA; external d3dx8dll name 'D3DXGetImageInfoFromFileA';
function D3DXGetImageInfoFromFileW; external d3dx8dll name 'D3DXGetImageInfoFromFileW';
function D3DXGetImageInfoFromFile; external d3dx8dll name 'D3DXGetImageInfoFromFileA';
function D3DXGetImageInfoFromResourceA; external d3dx8dll name 'D3DXGetImageInfoFromResourceA';
function D3DXGetImageInfoFromResourceW; external d3dx8dll name 'D3DXGetImageInfoFromResourceW';
function D3DXGetImageInfoFromResource; external d3dx8dll name 'D3DXGetImageInfoFromResourceA';
function D3DXGetImageInfoFromFileInMemory; external d3dx8dll;
...
function D3DXSaveSurfaceToFileA; external d3dx8dll name 'D3DXSaveSurfaceToFileA';
function D3DXSaveSurfaceToFileW; external d3dx8dll name 'D3DXSaveSurfaceToFileW';
function D3DXSaveSurfaceToFile; external d3dx8dll name 'D3DXSaveSurfaceToFileA';

function D3DXLoadVolumeFromFileA; external d3dx8dll name 'D3DXLoadVolumeFromFileA';
function D3DXLoadVolumeFromFileW; external d3dx8dll name 'D3DXLoadVolumeFromFileW';
function D3DXLoadVolumeFromFile; external d3dx8dll name 'D3DXLoadVolumeFromFileA';
function D3DXLoadVolumeFromResourceA; external d3dx8dll name 'D3DXLoadVolumeFromResourceA';
function D3DXLoadVolumeFromResourceW; external d3dx8dll name 'D3DXLoadVolumeFromResourceW';
function D3DXLoadVolumeFromResource; external d3dx8dll name 'D3DXLoadVolumeFromResourceA';
function D3DXLoadVolumeFromFileInMemory; external d3dx8dll;

function D3DXLoadVolumeFromVolume; external d3dx8dll;
function D3DXLoadVolumeFromMemory; external d3dx8dll;
function D3DXSaveVolumeToFileA; external d3dx8dll name 'D3DXSaveVolumeToFileA';
function D3DXSaveVolumeToFileW; external d3dx8dll name 'D3DXSaveVolumeToFileW';
function D3DXSaveVolumeToFile; external d3dx8dll name 'D3DXSaveVolumeToFileA';
...
function D3DXCreateVolumeTextureFromFileA; external d3dx8dll name 'D3DXCreateVolumeTextureFromFileA';
function D3DXCreateVolumeTextureFromFileW; external d3dx8dll name 'D3DXCreateVolumeTextureFromFileW';
function D3DXCreateVolumeTextureFromFile; external d3dx8dll name 'D3DXCreateVolumeTextureFromFileA';
...
function D3DXCreateCubeTextureFromResourceA; external d3dx8dll name 'D3DXCreateCubeTextureFromResourceA';
function D3DXCreateCubeTextureFromResourceW; external d3dx8dll name 'D3DXCreateCubeTextureFromResourceW';
function D3DXCreateCubeTextureFromResource; external d3dx8dll name 'D3DXCreateCubeTextureFromResourceA';
function D3DXCreateVolumeTextureFromResourceA; external d3dx8dll name 'D3DXCreateVolumeTextureFromResourceA';
function D3DXCreateVolumeTextureFromResourceW; external d3dx8dll name 'D3DXCreateVolumeTextureFromResourceW';
function D3DXCreateVolumeTextureFromResource; external d3dx8dll name 'D3DXCreateVolumeTextureFromResourceA';
...
function D3DXCreateVolumeTextureFromFileExA; external d3dx8dll name 'D3DXCreateVolumeTextureFromFileExA';
function D3DXCreateVolumeTextureFromFileExW; external d3dx8dll name 'D3DXCreateVolumeTextureFromFileExW';
function D3DXCreateVolumeTextureFromFileEx; external d3dx8dll name 'D3DXCreateVolumeTextureFromFileExA';
...
function D3DXCreateCubeTextureFromResourceExA; external d3dx8dll name 'D3DXCreateCubeTextureFromResourceExA';
function D3DXCreateCubeTextureFromResourceExW; external d3dx8dll name 'D3DXCreateCubeTextureFromResourceExW';
function D3DXCreateCubeTextureFromResourceEx; external d3dx8dll name 'D3DXCreateCubeTextureFromResourceExA';
function D3DXCreateVolumeTextureFromResourceExA; external d3dx8dll name 'D3DXCreateVolumeTextureFromResourceExA';
function D3DXCreateVolumeTextureFromResourceExW; external d3dx8dll name 'D3DXCreateVolumeTextureFromResourceExW';
function D3DXCreateVolumeTextureFromResourceEx; external d3dx8dll name 'D3DXCreateVolumeTextureFromResourceExA';
...
function D3DXCreateVolumeTextureFromFileInMemory; external d3dx8dll;
...
function D3DXCreateVolumeTextureFromFileInMemoryEx; external d3dx8dll;

function D3DXSaveTextureToFileA; external d3dx8dll name 'D3DXSaveTextureToFileA';
function D3DXSaveTextureToFileW; external d3dx8dll name 'D3DXSaveTextureToFileW';
function D3DXSaveTextureToFile; external d3dx8dll name 'D3DXSaveTextureToFileA';
function D3DXFilterTexture; external d3dx8dll;
// #define D3DXFilterCubeTexture D3DXFilterTexture
function D3DXFilterCubeTexture; external d3dx8dll name 'D3DXFilterTexture';
// #define D3DXFilterVolumeTexture D3DXFilterTexture
function D3DXFilterVolumeTexture; external d3dx8dll name 'D3DXFilterTexture';

function D3DXFillTexture; external d3dx8dll;
function D3DXFillCubeTexture; external d3dx8dll;
function D3DXFillVolumeTexture; external d3dx8dll;
